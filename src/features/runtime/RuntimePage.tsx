...
export function RuntimePage({ client }: { client: ApiClient }) {
  ...
  return <Stack spacing={3}><Typography variant="h4">Runtime</Typography>
    ...
    <Paper variant="outlined"><Table><TableHead><TableRow><TableCell>Red</TableCell><TableCell>Acción</TableCell><TableCell>Estado</TableCell><TableCell>Motor</TableCell><TableCell>Cancelación</TableCell></TableRow></TableHead>
